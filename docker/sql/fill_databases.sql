...
INSERT INTO employees (firstName, lastName, birthDate, address, email, phone, position, departmentId, hireDate) VALUES
                                                                                                                    ('Marek', 'Hudák', '1991-03-12', 'Prešov', 'mhudak@example.com', '0900000006', 'Developer', 1, '2021-01-10'),
                                                                                                                    ('Simona', 'Krajčíková', '1994-07-18', 'Bratislava', 'skrajcikova@example.com', '0900000007', 'Recruiter', 2, '2020-06-01'),
                                                                                                                    ('Tomáš', 'Mikula', '1989-11-01', 'Martin', 'tmikula@example.com', '0900000008', 'Analyst', 3, '2019-03-15'),
                                                                                                                    ('Lenka', 'Urbanová', '1997-02-21', 'Poprad', 'lurbanova@example.com', '0900000009', 'Designer', 4, '2022-05-11'),
                                                                                                                    ('Filip', 'Kmeť', '1993-08-10', 'Nitra', 'fkmet@example.com', '0900000010', 'Operator', 5, '2018-09-01'),

                                                                                                                    ('Patrik', 'Šimko', '1990-01-14', 'Žilina', 'psimko@example.com', '0900000011', 'Logistics Specialist', 6, '2020-01-01'),
                                                                                                                    ('Dominika', 'Vaňová', '1995-06-30', 'Košice', 'dvanova@example.com', '0900000012', 'QA Tester', 7, '2021-07-01'),
                                                                                                                    ('Samuel', 'Bartoš', '1992-09-05', 'Bratislava', 'sbartos@example.com', '0900000013', 'Researcher', 8, '2019-10-20'),
                                                                                                                    ('Nikola', 'Farkašová', '1998-12-24', 'Trenčín', 'nfarkasova@example.com', '0900000014', 'Manager', 9, '2023-02-01'),
                                                                                                                    ('Erik', 'Polák', '1987-04-04', 'Levice', 'epolak@example.com', '0900000015', 'Buyer', 10, '2017-12-01'),

                                                                                                                    ('Michaela', 'Kováčová', '1991-05-20', 'Bratislava', 'mkovacova@example.com', '0900000016', 'Data Analyst', 1, '2020-11-11'),
                                                                                                                    ('Roman', 'Král', '1986-07-07', 'Žilina', 'rkral@example.com', '0900000017', 'Backend Developer', 2, '2016-04-05'),
                                                                                                                    ('Andrea', 'Lukáčová', '1999-08-19', 'Košice', 'alukacova@example.com', '0900000018', 'DevOps Engineer', 3, '2024-01-01'),
                                                                                                                    ('Juraj', 'Švec', '1993-10-11', 'Prešov', 'jsvec@example.com', '0900000019', 'Administrator', 4, '2018-06-15'),
                                                                                                                    ('Barbora', 'Kučerová', '1996-03-28', 'Nitra', 'bkucerova@example.com', '0900000020', 'Support Agent', 5, '2022-09-09'),

                                                                                                                    ('Adam', 'Tóth', '1990-01-01', 'Bratislava', 'atoth@example.com', '0900000021', 'Developer', 1, '2019-01-01'),
                                                                                                                    ('Veronika', 'Sláviková', '1995-02-02', 'Trnava', 'vslavikova@example.com', '0900000022', 'HR Specialist', 2, '2021-02-02'),
                                                                                                                    ('Daniel', 'Černý', '1988-03-03', 'Žilina', 'dcerny@example.com', '0900000023', 'Financial Analyst', 3, '2017-03-03'),
                                                                                                                    ('Petra', 'Gregorová', '1994-04-04', 'Košice', 'pgregorova@example.com', '0900000024', 'Marketing Manager', 4, '2020-04-04'),
                                                                                                                    ('Róbert', 'Marek', '1991-05-05', 'Nitra', 'rmarek@example.com', '0900000025', 'Operator', 5, '2018-05-05'),

                                                                                                                    ('Alena', 'Veselá', '1992-06-06', 'Poprad', 'avesela@example.com', '0900000026', 'Logistics Manager', 6, '2019-06-06'),
                                                                                                                    ('Karol', 'Benko', '1989-07-07', 'Martin', 'kbenko@example.com', '0900000027', 'QA Engineer', 7, '2016-07-07'),
                                                                                                                    ('Ivana', 'Molnárová', '1997-08-08', 'Prievidza', 'imolnarova@example.com', '0900000028', 'Scientist', 8, '2022-08-08'),
                                                                                                                    ('Marián', 'Hruška', '1985-09-09', 'Banská Bystrica', 'mhruska@example.com', '0900000029', 'Director', 9, '2015-09-09'),
                                                                                                                    ('Zuzana', 'Kleinová', '1993-10-10', 'Trenčín', 'zkleinova@example.com', '0900000030', 'Procurement Specialist', 10, '2020-10-10'),

                                                                                                                    ('Oliver', 'Kováč', '1994-11-11', 'Bratislava', 'okovac@example.com', '0900000031', 'BI Analyst', 1, '2021-11-11'),
                                                                                                                    ('Nina', 'Biela', '1996-12-12', 'Žilina', 'nbiela@example.com', '0900000032', 'Frontend Developer', 2, '2023-12-12'),
                                                                                                                    ('Kristián', 'Vlk', '1991-01-13', 'Košice', 'kvlk@example.com', '0900000033', 'Cloud Engineer', 3, '2019-01-13'),
                                                                                                                    ('Laura', 'Sedláčková', '1998-02-14', 'Nitra', 'lsedlackova@example.com', '0900000034', 'Office Manager', 4, '2024-02-14'),
                                                                                                                    ('Matej', 'Oravec', '1990-03-15', 'Prešov', 'moravec@example.com', '0900000035', 'Support Specialist', 5, '2018-03-15');
